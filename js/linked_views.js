...
queue()
  ...
  .defer(d3.csv, '../data/data_par.csv')
  .defer(d3.csv, '../data/codes.csv')
...
function makelinked_views(error, data, data_par, codes) {
  ...
  var svg = d3.select("#linked_views_body").append("svg")
  ...
  function drawmap(variable) {
    ...
    var paletteScale = d3.scale.linear()
        ...
        .range(["#fff7fb","#023858"]); // blue color
        ...
        geographyConfig: {
            ...
            popupTemplate: function(geo, data) {
                ...
                return ['<div class="hoverinfo">',
                    ...
                    '<br>population: <span style="color:white"<strong>', data.population, '</strong></span>',
                    '<br>GDP: <span style="color:white"<strong>', data.GDP, '</strong></span>',
                    '<br>Life expectancy: <span style="color:white"<strong>', data.life_expectancy, '</strong></span>',
                    '<br>Well being: <span style="color:white"<strong>', data.well_being, '</strong></span>',
                    '<br>Happy life years: <span style="color:white"<strong>', data.happy_life_years, '</strong></span>',
                    '<br>Carbon footprint: <span style="color:white"<strong>', data.footprint, '</strong></span>',
                    '<br>Happy people index: <span style="color:white"<strong>', data.HPI, '</strong></span>',
                    '</div>'].join('');
            }
        }
    });
